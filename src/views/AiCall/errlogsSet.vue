      ...
      <div class="topDiv">
        ...
        <div>
          <el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%">
            <el-table-column prop="visitorName" label="客户名称" width="220">
            </el-table-column>
            <el-table-column prop="visitorAccount" label="登录账户" width="180">
            </el-table-column>
            <el-table-column prop="platformId" label="客户来源" width="180">
            </el-table-column>
            <el-table-column prop="visitorClass" width="200" label="客户等级"></el-table-column>
            <el-table-column prop="beginTime" width="200" label="到访时间"></el-table-column>
            <el-table-column prop="endTime" width="200" label="结束时间"></el-table-column>
            <el-table-column prop="isReply" width="200" label="是否发起会话"></el-table-column>
