...
<template>
  <div>
    <el-dialog :close-on-click-modal='false' :title="'导入线索'" :visible.sync="open" width="80%">
      ...
      <div v-show="active == 3">
        <div class="importSuccess">
          <i style="color: #4bd863" class="el-icon-success"></i>
          <p>批量导入完成</p>
          <p>成功导入线索{{ uploadAfterData.success }}条</p>
        </div>
        <div></div>
...
<script>
import { getTemplate, performImport, importAll } from "@/api/saleslead/index";
