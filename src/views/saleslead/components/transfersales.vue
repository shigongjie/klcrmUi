<template>
  <el-dialog :close-on-click-modal='false' :title="'转移线索'" :visible.sync="open" width="60%">
    <el-form class="selfForm" ref="rulesForm" :model="submitParams" label-width="100px" size="small">
      ...
      <el-form-item label="备注信息">
        <el-input type="textarea" v-model="submitParams.remark" placeholder="请输入备注信息"></el-input>
      </el-form-item>
    </el-form>
...
<script>
import { getstaffList, transfersales } from "@/api/customer/index";
export default {
  props: {
    ids: {},
  },
  ...
  methods: {
    submit() {
      ...
      data.staffId = this.submitParams.userId;
      transfersales(data).then((res) => {
        this.open = false;
        this.$message({
          type: "success",
          message: "转移成功!",
